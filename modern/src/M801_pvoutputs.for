      ...
      contains
      subroutine init_pvoutputs(xo, yo, zo, dx, dy, dz, numprocs, comm)
      implicit none
     ...
     & gpid, description)
      ...
      integer(2),intent(in) :: a(1-ng:iml+ng,1-ng:jml+ng,1-ng:kml+ng)
     ...
     &                            0,bc_imori-1,0,bc_jmori-1,0,bc_kmori-1
     ...
     & '<DataArray Name="x" type="Float32" format="ascii">'
      do i=itmp,iu-1
            write(1002,'(E21.15)') i*dx_o
      enddo
      write(1002,'(A)')'</DataArray>'
      write(1002,'(A)')
     & '<DataArray Name="y" type="Float32" format="ascii">'
      do j=jtmp,ju-1
            write(1002,'(E21.15)') j*dy_o
      enddo
      write(1002,'(A)')'</DataArray>'
      write(1002,'(A)')
     & '<DataArray Name="z" type="Float32" format="ascii">'
      do k=ktmp,ku-1
            write(1002,'(E21.15)') k*dz_o
      enddo
      write(1002,'(A)')'</DataArray>'
      write(1002,'(A)')'</Coordinates>'
     ...
     & description)
      ...
      !include 'mpif.h'
      integer(4),intent(in) :: ng
      integer(2),intent(in) :: a(1-ng:iml+ng,1:1,1-ng:kml+ng)
      character(len=*),intent(in) :: fnamebase
      integer(4),intent(in) :: timestep
      real(8),intent(in) :: timeval
      integer(4),intent(in) :: gpid
     ...
     & gpid, description)
      ...
      !include 'mpif.h'
      integer(4),intent(in) :: ng
      real(4),intent(in) :: a(1-ng:iml+ng,1-ng:jml+ng,1-ng:kml+ng)
      character(len=*),intent(in) :: fnamebase
      integer(4),intent(in) :: timestep, gpid
      character(len=*),intent(in) :: description
     ...
     & gpid, description)
      ...
      !include 'mpif.h'
      integer(4),intent(in) :: ng
      real(4),intent(in) :: a(1-ng:iml+ng,1:1,1-ng:kml+ng)
      character(len=*),intent(in) :: fnamebase
      integer(4),intent(in) :: timestep, gpid
      character(len=*),intent(in) :: description
