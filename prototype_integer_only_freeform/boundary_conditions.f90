...
call MPI_ISEND(a_il_s(1-ng,1-ng,1),size(a_il_s),MPI_INTEGER,pidto01,5001,MPI_COMM_WORLD,isend01,ierr)
call MPI_ISEND(a_iu_s(1-ng,1-ng,1),size(a_iu_s),MPI_INTEGER,pidto02,5002,MPI_COMM_WORLD,isend02,ierr)
call MPI_ISEND(a_jl_s(1-ng,1-ng,1),size(a_jl_s),MPI_INTEGER,pidto03,5003,MPI_COMM_WORLD,isend03,ierr)
call MPI_ISEND(a_ju_s(1-ng,1-ng,1),size(a_ju_s),MPI_INTEGER,pidto04,5004,MPI_COMM_WORLD,isend04,ierr)
call MPI_ISEND(a_kl_s(1-ng,1-ng,1),size(a_kl_s),MPI_INTEGER,pidto05,5005,MPI_COMM_WORLD,isend05,ierr)
call MPI_ISEND(a_ku_s(1-ng,1-ng,1),size(a_ku_s),MPI_INTEGER,pidto06,5006,MPI_COMM_WORLD,isend06,ierr)
...
call MPI_IRECV(a_il_r(1-ng,1-ng,1),size(a_il_r),MPI_INTEGER,pidfrom01,5002,MPI_COMM_WORLD,irecv01,ierr)
call MPI_IRECV(a_iu_r(1-ng,1-ng,1),size(a_iu_r),MPI_INTEGER,pidfrom02,5001,MPI_COMM_WORLD,irecv02,ierr)
call MPI_IRECV(a_jl_r(1-ng,1-ng,1),size(a_jl_r),MPI_INTEGER,pidfrom03,5004,MPI_COMM_WORLD,irecv03,ierr)
call MPI_IRECV(a_ju_r(1-ng,1-ng,1),size(a_ju_r),MPI_INTEGER,pidfrom04,5003,MPI_COMM_WORLD,irecv04,ierr)
call MPI_IRECV(a_kl_r(1-ng,1-ng,1),size(a_kl_r),MPI_INTEGER,pidfrom05,5006,MPI_COMM_WORLD,irecv05,ierr)
call MPI_IRECV(a_ku_r(1-ng,1-ng,1),size(a_ku_r),MPI_INTEGER,pidfrom06,5005,MPI_COMM_WORLD,irecv06,ierr)
...
call MPI_ISEND(a_iljl_s(1-ng,1,1),size(a_iljl_s),MPI_INTEGER,pidto01,5001,MPI_COMM_WORLD,isend01,ierr)
call MPI_ISEND(a_ilju_s(1-ng,1,1),size(a_ilju_s),MPI_INTEGER,pidto02,5002,MPI_COMM_WORLD,isend02,ierr)
call MPI_ISEND(a_iujl_s(1-ng,1,1),size(a_iujl_s),MPI_INTEGER,pidto03,5003,MPI_COMM_WORLD,isend03,ierr)
call MPI_ISEND(a_iuju_s(1-ng,1,1),size(a_iuju_s),MPI_INTEGER,pidto04,5004,MPI_COMM_WORLD,isend04,ierr)
call MPI_ISEND(a_jlkl_s(1-ng,1,1),size(a_jlkl_s),MPI_INTEGER,pidto05,5005,MPI_COMM_WORLD,isend05,ierr)
call MPI_ISEND(a_jlku_s(1-ng,1,1),size(a_jlku_s),MPI_INTEGER,pidto06,5006,MPI_COMM_WORLD,isend06,ierr)
call MPI_ISEND(a_jukl_s(1-ng,1,1),size(a_jukl_s),MPI_INTEGER,pidto07,5007,MPI_COMM_WORLD,isend07,ierr)
call MPI_ISEND(a_juku_s(1-ng,1,1),size(a_juku_s),MPI_INTEGER,pidto08,5008,MPI_COMM_WORLD,isend08,ierr)
call MPI_ISEND(a_klil_s(1-ng,1,1),size(a_klil_s),MPI_INTEGER,pidto09,5009,MPI_COMM_WORLD,isend09,ierr)
call MPI_ISEND(a_kliu_s(1-ng,1,1),size(a_kliu_s),MPI_INTEGER,pidto10,5010,MPI_COMM_WORLD,isend10,ierr)
call MPI_ISEND(a_kuil_s(1-ng,1,1),size(a_kuil_s),MPI_INTEGER,pidto11,5011,MPI_COMM_WORLD,isend11,ierr)
call MPI_ISEND(a_kuiu_s(1-ng,1,1),size(a_kuiu_s),MPI_INTEGER,pidto12,5012,MPI_COMM_WORLD,isend12,ierr)
...
call MPI_IRECV(a_iljl_r(1-ng,1,1),size(a_iljl_r),MPI_INTEGER,pidfrom01,5004,MPI_COMM_WORLD,irecv01,ierr)
call MPI_IRECV(a_ilju_r(1-ng,1,1),size(a_ilju_r),MPI_INTEGER,pidfrom02,5003,MPI_COMM_WORLD,irecv02,ierr)
call MPI_IRECV(a_iujl_r(1-ng,1,1),size(a_iujl_r),MPI_INTEGER,pidfrom03,5002,MPI_COMM_WORLD,irecv03,ierr)
call MPI_IRECV(a_iuju_r(1-ng,1,1),size(a_iuju_r),MPI_INTEGER,pidfrom04,5001,MPI_COMM_WORLD,irecv04,ierr)
call MPI_IRECV(a_jlkl_r(1-ng,1,1),size(a_jlkl_r),MPI_INTEGER,pidfrom05,5008,MPI_COMM_WORLD,irecv05,ierr)
call MPI_IRECV(a_jlku_r(1-ng,1,1),size(a_jlku_r),MPI_INTEGER,pidfrom06,5007,MPI_COMM_WORLD,irecv06,ierr)
call MPI_IRECV(a_jukl_r(1-ng,1,1),size(a_jukl_r),MPI_INTEGER,pidfrom07,5006,MPI_COMM_WORLD,irecv07,ierr)
call MPI_IRECV(a_juku_r(1-ng,1,1),size(a_juku_r),MPI_INTEGER,pidfrom08,5005,MPI_COMM_WORLD,irecv08,ierr)
call MPI_IRECV(a_klil_r(1-ng,1,1),size(a_klil_r),MPI_INTEGER,pidfrom09,5012,MPI_COMM_WORLD,irecv09,ierr)
call MPI_IRECV(a_kliu_r(1-ng,1,1),size(a_kliu_r),MPI_INTEGER,pidfrom10,5011,MPI_COMM_WORLD,irecv10,ierr)
call MPI_IRECV(a_kuil_r(1-ng,1,1),size(a_kuil_r),MPI_INTEGER,pidfrom11,5010,MPI_COMM_WORLD,irecv11,ierr)
call MPI_IRECV(a_kuiu_r(1-ng,1,1),size(a_kuiu_r),MPI_INTEGER,pidfrom12,5009,MPI_COMM_WORLD,irecv12,ierr)
...
call MPI_ISEND(a_lll_s(1,1,1),size(a_lll_s),MPI_INTEGER,pidto01,5001,MPI_COMM_WORLD,isend01,ierr)
call MPI_ISEND(a_ull_s(1,1,1),size(a_ull_s),MPI_INTEGER,pidto02,5002,MPI_COMM_WORLD,isend02,ierr)
call MPI_ISEND(a_lul_s(1,1,1),size(a_lul_s),MPI_INTEGER,pidto03,5003,MPI_COMM_WORLD,isend03,ierr)
call MPI_ISEND(a_uul_s(1,1,1),size(a_uul_s),MPI_INTEGER,pidto04,5004,MPI_COMM_WORLD,isend04,ierr)
call MPI_ISEND(a_llu_s(1,1,1),size(a_llu_s),MPI_INTEGER,pidto05,5005,MPI_COMM_WORLD,isend05,ierr)
call MPI_ISEND(a_ulu_s(1,1,1),size(a_ulu_s),MPI_INTEGER,pidto06,5006,MPI_COMM_WORLD,isend06,ierr)
call MPI_ISEND(a_luu_s(1,1,1),size(a_luu_s),MPI_INTEGER,pidto07,5007,MPI_COMM_WORLD,isend07,ierr)
call MPI_ISEND(a_uuu_s(1,1,1),size(a_uuu_s),MPI_INTEGER,pidto08,5008,MPI_COMM_WORLD,isend08,ierr)
...
call MPI_IRECV(a_lll_r(1,1,1),size(a_lll_r),MPI_INTEGER,pidfrom01,5008,MPI_COMM_WORLD,irecv01,ierr)
call MPI_IRECV(a_ull_r(1,1,1),size(a_ull_r),MPI_INTEGER,pidfrom02,5007,MPI_COMM_WORLD,irecv02,ierr)
call MPI_IRECV(a_lul_r(1,1,1),size(a_lul_r),MPI_INTEGER,pidfrom03,5006,MPI_COMM_WORLD,irecv03,ierr)
call MPI_IRECV(a_uul_r(1,1,1),size(a_uul_r),MPI_INTEGER,pidfrom04,5005,MPI_COMM_WORLD,irecv04,ierr)
call MPI_IRECV(a_llu_r(1,1,1),size(a_llu_r),MPI_INTEGER,pidfrom05,5004,MPI_COMM_WORLD,irecv05,ierr)
call MPI_IRECV(a_ulu_r(1,1,1),size(a_ulu_r),MPI_INTEGER,pidfrom06,5003,MPI_COMM_WORLD,irecv06,ierr)
call MPI_IRECV(a_luu_r(1,1,1),size(a_luu_r),MPI_INTEGER,pidfrom07,5002,MPI_COMM_WORLD,irecv07,ierr)
call MPI_IRECV(a_uuu_r(1,1,1),size(a_uuu_r),MPI_INTEGER,pidfrom08,5001,MPI_COMM_WORLD,irecv08,ierr)
...
subroutine update_plane_i4(aout, planetype, ain, il,iu,jl,ju,ng,copymode)
use input
implicit none
integer(4),intent(inout) :: aout(1-ng:iml+ng,1-ng:jml+ng,1-ng:kml+ng)
...
case('mirror')
      ...
      case('uuu')
            ...
            do n2=0,ng-1
            do n1=0,ng-1
                  aout(iml+1+n1,jml+1+n2,kml+1+n3)=ain(ng-n3,ng-n2,ng-n1)
            enddo
            enddo
            enddo
      end select !select case(trim(cornertype))
